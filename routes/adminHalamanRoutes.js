...
module.exports = (fastify) => {
  fastify.get('/adminTC_1919', isAdmin, (req, res) => {
  ...
  fastify.get('/adminTC_1919/tambah-halaman', isAdmin, (req, res) => {
    let title = ""
    let slug = ""
    let desc = ""
  ...
  fastify.post('/adminTC_1919/tambah-halaman', (req, res) => {
  ...
  fastify.get('/adminTC_1919/edit-halaman/:id', isAdmin, (req, res) => {
    let errors;
  ...
  fastify.post('/adminTC_1919/edit-halaman/:id', (req, res) => {
  ...
  fastify.get('/adminTC_1919/hapus-halaman/:id', isAdmin, (req, res) => {
